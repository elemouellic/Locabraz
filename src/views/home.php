<main>
        ...
        <form class="home-form" action="process.php<--a définir-->" class="search">
        <input class="input" type="date" name="trip-start" id="start"
                value='<?php echo date("Y-m-d", mktime(0, 0, 0, date("m"), date("d"), date("Y"))); ?>'>
            <input class="input" type="date" name="trip-arrival" id="arrival"
                value='<?php echo date("Y-m-d", mktime(0, 0, 0, date("m"), date("d")+10, date("Y"))); ?>'>
